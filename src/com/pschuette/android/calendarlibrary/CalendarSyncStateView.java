...
public class CalendarSyncStateView extends LinearLayout {
	...
	public CalendarSyncStateView(Context context, OnSyncStateChangedListener syncStateChangeListener) {
		super(context);
	...
	private void drawCalendarsWithSyncState() {
		...
		if (isLoadingCalendars) {
			...
			syncStateAdapter.registerSyncStateChangeListener(syncChangeListener);
